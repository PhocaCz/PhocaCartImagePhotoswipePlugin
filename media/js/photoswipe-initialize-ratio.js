var initPhotoSwipeFromDOM = function(gallerySelector) {
    ...
    //var onThumbnailsClick = function(e) {
		var onThumbnailsClick = jQuery('.pc-photoswipe-button').on('click', function(e) {
        e = e || window.event;
       ...
       /* NOT DIRECT PARENT var clickedGallery = clickedListItem.parentNode,*/
		...
		var clickedGalleryObject = jQuery(clickedListItem).closest('div.pc-photoswipe'),
...
initPhotoSwipeFromDOM('.pc-photoswipe');
